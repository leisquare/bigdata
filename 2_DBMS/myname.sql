...
SELECT ENAME,SAL FROM EMP WHERE ENAME LIKE 'C%' OR LIKE 'P%';
...
SELECT * FROM EMP WHERE JOB = 'CLERK' AND SAL NOT IN(1000,3000,5000) OR JOB = 'ANALYST' AND SAL NOT IN(1000,3000,5000);
